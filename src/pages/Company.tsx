...
export default function Company() {
   ...
   return (
      <Container>
         ...
         <div className="flex flex-col items-center justify-center w-full">
            <div className="text-center">
               <SectionTitle preTitle="About" title="About WindReact" align="center">
                  We're a dynamic team of creative minds, developers, and marketers committed to transforming ideas into impactful digital
                  experiences.
               </SectionTitle>
            </div>
         ...
         {/* Company Values */}
         <div className="py-10">
            <SectionTitle preTitle="Our Values" title="What drives us forward" align="center">
            ...
            <div className="grid gap-8 mt-12 md:grid-cols-3 max-w-screen-xl mx-auto">
               {companyValues.map((value) => (
                  <div key={value.title} className="p-6 bg-gray-100 dark:bg-gray-800 rounded-xl">
                     ...
                     <h3 className="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-200">{value.title}</h3>
         ...
         {/* Team Section */}
         <div className="py-20">
            <SectionTitle align="center" preTitle="Our Team" title="The amazing team behind WindReact">
