      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
         <Container>
            ...
            <div className="py-4 flex justify-center">
               <Link to="/" className="flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
            ...
            <div className="flex min-h-[80vh] items-center justify-center flex-col space-y-4">
               <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-lg dark:bg-gray-800">
                  <div>
                     <SectionTitle preTitle="Create account" title="Sign Up" align="center"></SectionTitle>
                  </div>
