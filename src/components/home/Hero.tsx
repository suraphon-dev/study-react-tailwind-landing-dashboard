   ...
   return (
      <>
         <Container className="flex flex-wrap">
            <div className="flex items-center w-full lg:w-1/2">
              ...
              React 19 & Tailwind CSS 4.0 and its free to use. */}
                     WindReact เป็นเทมเพลตเว็บไซต์สำหรับการออกแบบและการตลาดที่ทันสมัย เหมาะสำหรับสตาร์ทอัพและโปรเจกต์อิสระ พัฒนาโดยใช้ React 19 และ
         ...
         <Container>
            ...
            customers worldwide */}
                  ได้รับความไว้วางใจจากลูกค้ากว่า <span className="text-indigo-600 dark:text-indigo-400">2000+</span> รายทั่วโลก
               </div>
