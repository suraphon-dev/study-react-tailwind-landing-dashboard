...
export default function Sidebar() {
   ...
   return (
      <>
         ...
         {/* Mobile Menu Overlay */}
         {isMobileMenuOpen && <div className="fixed inset-0 bg-black bg-opacity-50 lg:hidden z-40" onClick={() => setIsMobileMenuOpen(false)} />}
         ...
         >
            <div className="flex flex-col h-screen pt-5 overflow-y-auto bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800">
               ...
               <nav className="flex-1 px-3 mt-5">
                  ...
                  {!isCollapsed && (
                     <div className="pt-6">
                        <div className="px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Your teams</div>
               ...
               <div className="px-3 pb-4">
                  <Link
                     ...
                     onClick={handleMenuClick}
                     className={`flex items-center px-3 py-2 text-sm font-medium rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-50 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-800 ${
                        location.pathname === '/dashboard/settings' ? 'bg-indigo-50 text-indigo-600 dark:bg-gray-800 dark:text-white' : ''
                     }`}
                  >
