         ...
         <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="flex items-center space-x-4">
               ...
               <div className="relative" ref={dropdownRef}>
                  <button onClick={() => setIsProfileOpen(!isProfileOpen)} className="flex items-center space-x-2 mr-2">
                     <img className="w-8 h-8 rounded-full" src="/images/avatar.avif" alt="" />
                     <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Tom Cook</span>
                  </button>
