            ...
            <nav className="relative flex flex-wrap items-center justify-between mx-auto lg:justify-between max-w-screen-xl">
               ...
               <div className="flex items-center gap-3 nav__item mr-2 lg:flex ml-auto lg:ml-0 lg:order-2">
                  ...
                  <div className="hidden mr-3 lg:flex nav__item">
                     <Link to="/login" className="px-6 py-2 text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
                        Sign In
                     </Link>
                  </div>
               </div>
               ...
               {isOpen && (
                  <div ref={mobileMenuRef} className="flex flex-wrap w-full my-5 lg:hidden">
                     ...
                     {productDropdown && <div className="w-full bg-gray-50 dark:bg-gray-800">{renderDropdownItems(productMenus, true)}</div>}
                     ...
                     {featureDropdown && <div className="w-full bg-gray-50 dark:bg-gray-800">{renderDropdownItems(featureMenus, true)}</div>}
                    ...
                    ${location.pathname === item.path ? 'text-indigo-600 dark:text-indigo-400' : ''}`}
                     ...
                     {/* Get Started button */}
                     <Link to="/login" className="w-full px-6 py-2 mt-3 text-center text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
                        Sign In
                     </Link>
                  </div>
               )}
