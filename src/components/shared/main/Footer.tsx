      ...
      <div className="relative bg-gray-200 dark:bg-gray-800">
         <Container>
            <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 lg:grid-cols-5">
               <div className="lg:col-span-2">
                  ...
                  <div className="max-w-md mt-4 text-gray-600 dark:text-gray-400">
                     WindReact is a free landing page & marketing website template for startups and indie projects. Its built with React & Tailwind
                     CSS.
                  </div>
               </div>
            ...
            <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
               ...
               <a href="https://itgenius.co.th" target="_blank" rel="noopener noreferrer" className="hover:underline">
                  ITGeniusEng.
               </a>{' '}
               Illustrations from{' '}
